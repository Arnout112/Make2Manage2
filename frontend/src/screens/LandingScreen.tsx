  ...
  const features = [
    {
      ...
      description:
        "Experience real-time make-to-order production planning with interactive departments and order routing.",
    },
    {
      icon: BarChart3,
      title: "Performance Analytics",
      description:
        "Track lead times, utilization rates, and bottlenecks to optimize your manufacturing processes.",
    },
    {
      icon: Users,
      title: "Educational Focus",
      description:
        "Designed for business students and lifelong learners in the Limburg SME manufacturing industry.",
    },
    {
      icon: Target,
      title: "Decision Making",
      description:
        "Learn to balance cost efficiency with delivery reliability in dynamic market conditions.",
    },
  ];
    ...
    <div className="flex-1 overflow-y-auto bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="relative px-8 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl font-bold text-gray-900 mb-6">Make2Manage</h1>

          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            A digital learning game designed to teach manufacturing planning and
            control concepts in the Limburg SME manufacturing industry
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Interactive learning through realistic manufacturing scenarios
            </p>
          </div>
      ...
      <div className="px-8 py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              What you'll learn through this interactive experience
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            {learningObjectives.map((objective, index) => (
              <div
                key={index}
                className="flex items-center p-6 bg-white rounded-lg border border-gray-200"
              >
