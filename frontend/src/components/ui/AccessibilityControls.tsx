  ...
  return (
    <>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => {
                          updateSetting(
                            "fontSize",
                            e.target.value as AccessibilitySettings["fontSize"]
                          );
                          announceChange(
                            `Font size changed to ${e.target.value}`
                          );
                        }}
                      ...
                      <div className="flex items-center space-x-2">
                        <button
                          onClick={() => {
                            ...
                            announceChange(
                              `Zoom level decreased to ${newZoom} percent`
                            );
                          }}
                        ...
                        <button
                          onClick={() => {
                            ...
                            updateSetting("zoomLevel", newZoom);
                            announceChange(
                              `Zoom level increased to ${newZoom} percent`
                            );
                          }}
                          className="p-2 bg-gray-100 rounded hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div className="sr-only">
        <p>
          This is an educational manufacturing simulation game. Use Tab to
          navigate between controls, Enter or Space to activate buttons, and
          arrow keys to navigate within components.
        </p>
